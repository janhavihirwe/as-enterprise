...
import bg from "../../assets/bgbuyback.png"
  ...
  return (
    <div>
                ...
                <div style={{ position: 'relative', zIndex: 1,paddingTop:"80px"}}>
                    <div className='text-[#FFFFFF] text-[25px] lg:text-[40px] font-[700] lg:leading-[48px]'>Device Buyback Program</div>
                    <div className='text-[#E5E7EB] text-[20px] font-[400] leading-[28px] lg:w-[40%] mx-auto mt-[20px]'>Get value for your old IT assets and upgrade smartly</div>
                ...
                <div className='flex flex-col lg:flex-row gap-x-6 w-[95%] mx-auto mt-[80px] items-center gap-y-6'>
                    <div className='border border-[#E5E7EB] p-[15px] rounded-[8px] shadow-sm lg:w-[30%] w-[85%]'>
                        <img src={security}/>
                        <div className='font-[18px] font-[600] leading-[28px]'>Laptop & Desktop Buyback</div>
                    ...
                    <div className='border border-[#E5E7EB] p-[15px] rounded-[8px] shadow-sm lg:w-[30%] w-[85%]'>
                        <img src={setting}/>
                        <div className='font-[18px] font-[600] leading-[28px]'>Server & Network Equipment</div>
                    ...
                    <div className='border border-[#E5E7EB] p-[15px] rounded-[8px] shadow-sm lg:w-[30%] w-[85%]'>
                        <img src={insight}/>
                        <div className='font-[18px] font-[600] leading-[28px]'>Bulk Corporate Buyback</div>
                        <div className='text-[16px] font-[400] leading-[24px] text-[#4B5563] w-[85%]'>System tuning for maximum speed and efficiency.</div>
                    </div>
                    <div className='border border-[#E5E7EB] p-[15px] rounded-[8px] shadow-sm lg:w-[30%] w-[85%]'>
                        <img src={malware}/>
                        <div className='font-[18px] font-[600] leading-[28px]'>Secure Data Wipe</div>
                        <div className='text-[16px] font-[400] leading-[24px] text-[#4B5563] w-[80%]'></div>Complete system cleaning and security enhancement.
                    </div>
                </div>
                <div className='mt-[100px] mb-[100px]'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-x-[140px] w-[85%] mx-auto mt-[60px] gap-y-6'>
                        <div className='flex flex-col items-center text-center lg:w-[30%]'>
                            <img src={star}/>
                            <div className='text-[20px] font-[600] leading-[18px] mt-[15px]'>Certified Data Sanitization</div>
                        ...
                        <div className='flex flex-col items-center text-center lg:w-[30%]'>
                            <img src={electricity}/>
                            <div className='text-[20px] font-[600] leading-[18px] mt-[15px]'>Transparent Process</div>
                            <div className='text-[#4B5563] text-[16px] font-[400] mt-[15px]'>Quick service delivery without compromising on quality.</div>
                        </div>
                        <div className='flex flex-col items-center text-center lg:w-[30%]'>
                            <img src={support}/>
                            <div className='text-[20px] font-[600] leading-[18px] mt-[15px]'>Competitive Offers</div>
